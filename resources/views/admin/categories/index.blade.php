...
<div class="container flex flex-row items-center justify-between p-4 mx-auto mt-5 border-b-4">
    ...
    <a href="{{ route('admin.categories.create') }}" class="px-6 py-2 text-white bg-gray-700 rounded-lg">
            ...
            <table class="block min-w-full border-collapse md:table">
                ...
                <tbody class="block md:table-row-group">
                    @foreach ($categories as $category)
                        <tr>
                            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{ $category->id }}</td>
                            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{ $category->name }}</td>
                            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{ $category->slug }}</td>
                            <td>
                                <a class="" href="{{ route('admin.categories.edit',$category) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
