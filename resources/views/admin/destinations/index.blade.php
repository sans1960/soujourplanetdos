...
<div class="container flex flex-row items-center justify-between p-4 mx-auto mt-5 border-b-4">
    <h1 class="text-2xl">All Destinations</h1>
    <a href="{{ route('admin.destinations.create') }}" class="px-6 py-2 text-white bg-gray-700 rounded-lg">
            ...
            <table class="block min-w-full border-collapse md:table">
                ...
                <tbody class="block md:table-row-group">
                    @foreach ($destinations as $destination)
                        <tr>
                            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{ $destination->id }}</td>
                            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{ $destination->name }}</td>
                            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{ $destination->slug }}</td>
                            <td>
                                <a class="" href="{{ route('admin.destinations.edit',$destination) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
