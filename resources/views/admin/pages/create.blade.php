...
<div class="container mx-auto">
    <div class="w-3/4 p-4 mx-auto mt-5 ">
        ...
        <form action="{{ route('admin.pages.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <input id="" type="text" class="w-full p-2 mt-5 border-2 border-blue-500 rounded-lg " name="name" value="" placeholder="Page name" required  autofocus>
            ...
            <input id="" type="date" class="w-full p-2 mt-5 border-2 border-blue-500 rounded-lg " name="date" value="" >
            <div class="mt-5">
