...
<div class="container mx-auto">
    <div class="w-1/2 p-4 mx-auto mt-5 ">
        <h1 class="mt-5 text-xl text-center font-patua-one"> Create Subregion</h1>
        <form action="{{ route('admin.subregions.store') }}" method="post">
            @csrf
            <input id="" type="text" class="w-full p-2 mt-5 border-2 border-blue-500 rounded-lg " name="name" value="" placeholder="Subregion name" required  autofocus>
